...
Features:
- Context-aware response generation using Groq (LLM) with strict QuantAI Hospital focus
...
class NZGroqClient:
    """Client for interacting with Groq LLM for QuantAI Hospital (Auckland) Assistant."""
